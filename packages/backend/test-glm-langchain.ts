/**
 * 测试 LangChain 调用 LiteLLM (GLM-4.7)
 */

import { ChatOpenAI } from "@langchain/openai"

const LITELLM_API_KEY = "sk-litellm-41e2a2d4d101255ea6e76fd59f96548a"
const LITELLM_BASE_URL = "http://localhost:4000"
const MODEL = "glm-4.7"  // litellm 模型名
...
async function main() {
  console.log("开始测试 LangChain + LiteLLM (GLM-4.7)...\n")
